...
extern void mat_prod_multiple_oil_7_7x59_10(uint8_t *result, const uint8_t *rmat, uint8_t *vec);
...
#define mat_prod_multiple_oil(result, rmat, vec) mat_prod_multiple_oil_7_7x59_10(result, rmat, vec)
